window.initCaseC=function(){
  ...
  function handleAnalystRecordDownload(){
    ...
    link.href='assets/docs/Gettysburg-Address-C03.pdf';
    link.download='Gettysburg Address.pdf';
    ...
    toast('Analyst Record downloaded. Complete it before continuing the recovery.');
  }
