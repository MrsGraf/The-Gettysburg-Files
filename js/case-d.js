window.initCaseD=function(){
  ...
  document.getElementById('verifyD5Devices')?.addEventListener('click',()=>{
    ...
    if(!ok){['d5DevicesRecovered','d5AnalysisRecovered','d5MethodBriefing','d5FileRestored'].forEach(id=>document.getElementById(id)?.classList.remove('show'));return;}
    holdReadingPosition(()=>{
      ['d5DevicesRecovered','d5AnalysisRecovered','d5MethodBriefing','d5FileRestored'].forEach(id=>document.getElementById(id)?.classList.add('show'));
    },readingY);
