# The Gettysburg Files — modular baseline v23
...
## Baseline status
v23 continues the approved modular baseline, restores the locally referenced image assets required by the site, and slows the second cinematic Prologue phase. The optional `js-txt-copies/` viewing folder is intentionally not included.
