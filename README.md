# The Gettysburg Files — unified archive baseline v68
...
## v68 · Project-wide visual and instructional unification
...
- Unified all file instruction cards with the blue archive edge used on the overview pages and added a consistent **ARCHIVE TRANSMISSION** signal marker.
...
- Retained all v67 Case File D workflows, colours, anchor corrections and the five-record device sequence.
