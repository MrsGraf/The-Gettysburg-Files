...
## Baseline status
v23 continues the approved modular baseline and incorporates the latest targeted visual and source refinements while leaving all unrelated archive modules unchanged.
