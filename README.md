# The Gettysburg Files — modular baseline v22
...
## Baseline status
v22 continues the approved modular baseline and incorporates the latest targeted visual and source refinements while leaving all unrelated archive modules unchanged.
